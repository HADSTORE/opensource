 ...
 */
package com.google.android.gcm.app;
...
//        ServerUtilities.register(context, registrationId);
    ...
    protected void onMessage(Context context, Intent intent) {
        ...
        Log.i(TAG, ""+intent.getStringExtra("ticker"));
    ...
    private static void generateNotification(Context context, String message) {
        ...
        Intent notificationIntent = new Intent(context, HadstroeActivity.class);
 ...
 // Message 수신 확인을 위한  Test Code
 	private void generateNotification2(Context context, String msg) {
 		Log.i("", "generateNotification");
 		
 		Notification notify = new Notification(R.drawable.defaultimage, 
         		"HadStore", System.currentTimeMillis());
//     	notify.icon = R.drawable.icon;
     	notify.tickerText = msg;
     	notify.when = System.currentTimeMillis();
     	notify.flags |= Notification.FLAG_AUTO_CANCEL;
     	notify.vibrate = new long[]{1000, 1000, 200, 200};
     	...
     	notify.setLatestEventInfo(context, "Justin", msg, pi);
