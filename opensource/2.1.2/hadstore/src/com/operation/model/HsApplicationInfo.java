...
public class HsApplicationInfo extends HsTotalWeight{
	...
	public Integer getUserUploadCnt() {
		return userUploadCnt;
	}
	public void setUserUploadCnt(Integer userUploadCnt) {
		this.userUploadCnt = userUploadCnt;
	}
