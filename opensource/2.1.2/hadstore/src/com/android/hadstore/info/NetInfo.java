...
//	public final static String NET_ADDRESS ="http://192.168.0.220";
	 ...
	 * 사용자 정보
	 */
	public final static String USER_ID_INFO = "/Hadstore/mobile/user/view/userInfo";
	
	/**
	 * 사용자 로그인
	 */
	public final static String INAPP_PAY ="/Hadstore/mobile/approval/create/money";
	 ...
	 * 사용자 Email 체크
	 */
	public final static String USER_EMAIL_CHECK ="/Hadstore/mobile/user/check/userEmail.json";
	 ...
	 * 공지사항 상세보기
	 */
	public final static String PAYMENT_CHECK  = "/Hadstore/mobile/setting/check/isDrm";
	
	/**
	 * 공지사항 상세보기
	 */
	public final static String EVENT_POPUP  = "http://www.hadfamily.com/Hadfamily/images/promotion.jpg";
	
	/**
	 * 에러정보 보내기
	 */
	public final static String ERROR  = "/Hadstore/mobile/setting/create/errorLog";
	...
	public final static int EMAIL_SUCCESS =102;
	public final static int EMAIL_FAIL =205;
	public final static int PAY_FAIL = 402;
	public final static int PAY_LACK = 401;
	public final static int INAPP_PACKAGENAME_FAIL = 602;
	public final static int INAPP_ID_PASSWORD_FAIL = 217;
