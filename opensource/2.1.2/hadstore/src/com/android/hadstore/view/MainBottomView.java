...
//		mDay = (TextView) mBottomView.findViewById(R.id.clock_day);
		...
		mBottomView.findViewById(R.id.main_gift_btn).setOnClickListener(this);
		mBottomView.findViewById(R.id.main_update_btn).setOnClickListener(this);
		mBottomView.findViewById(R.id.main_notify_btn).setOnClickListener(this);
	}
	...
	public void setPage(int height) {
		// TODO Auto-generated method stub
		mBottomView.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,height));
	}
